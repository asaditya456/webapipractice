    ...
    public partial class SeedingDataForDifficultiesandRegions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("457fcf25-81c9-4b54-9ff7-8e2d2b89e4fd"), "Medium" },
                    { new Guid("4b449048-5f8d-4f4a-be8d-3f2827933f8f"), "Hard" },
                    { new Guid("bf8e0ca5-5a0f-45f3-96be-aa82cfd9affe"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("457fcf25-81c9-4b54-9ff7-8e2d2b89e4fd"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("4b449048-5f8d-4f4a-be8d-3f2827933f8f"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("bf8e0ca5-5a0f-45f3-96be-aa82cfd9affe"));
